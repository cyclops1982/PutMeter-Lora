...
enum ConfigType
{
    ...
    RemoveCalData = 0xE0,
    PerformRefSpadCalibration = 0xE1,
    PerformSimpleOffsetCalibration = 0xE2,
    PerformXtalkCalibration = 0xE3,
    PrintCalibrationData = 0xE4,
    PerformVCELOffsetCalibration = 0xE5,
    Restart = 0xF0,
    ClearConfig = 0xF1,
    SaveConfig = 0xF2
...
private:
    ...
    ConfigOption configs[18] = {
        ...
        {"PerformRefSpadCalibration", ConfigType::PerformRefSpadCalibration, sizeof(ConfigurationParameters::_dummy), &configvalues._dummy, ConfigurationParameters::DoNothing},
        {"PerformSimpleOffsetCalibration", ConfigType::PerformSimpleOffsetCalibration, sizeof(ConfigurationParameters::_dummy), &configvalues._dummy, ConfigurationParameters::DoNothing},
        {"PerformXtalkCalibration", ConfigType::PerformXtalkCalibration, sizeof(ConfigurationParameters::_dummy), &configvalues._dummy, ConfigurationParameters::DoNothing},
        {"Print Calibration Data", ConfigType::PrintCalibrationData, sizeof(ConfigurationParameters::_dummy), &configvalues._dummy, ConfigurationParameters::DoNothing},
        {"PerformVCELOffsetCalibration", ConfigType::PerformVCELOffsetCalibration, sizeof(ConfigurationParameters::_dummy), &configvalues._dummy, ConfigurationParameters::DoNothing},
